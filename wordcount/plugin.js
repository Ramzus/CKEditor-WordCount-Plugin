...
CKEDITOR.plugins.add("wordcount", {
  ...
  init: function (editor) {
    ...
    var defaultConfig = {
      ...
      //KBytes limit properties for warning user, default is 2 mo/mb
      maxContentSize: 2,
    ...
    if (config.showContentSize) {
      defaultFormat += editor.lang.wordcount.contentSize + "%contentSize%" + " Mo";
    }
    ...
    function updateCounter(editorInstance) {
      ...
      if (text) {
        ...
        if (config.showContentSize) {
          contentSize = countBytes(text) * 1.024 / 1000000;
        }
      }
      ...
      if (config.showContentSize) {
        html = html.replace("%contentSize%", contentSize.toFixed(2));
      }
      ...
      if (config.maxContentSize < contentSize) {
